...
export const Reservation = () => {
  ...
  //para agregar parece
  //const [infoReserved, setInfoReserved] = useState(initialValue)
  //para ver parece
      ...
      if(isNaN(dateInput[0])){
        ...
        if(dateInput[0]<dateNow[2]){
          ...
          if(dateInput[0]>dateNow[2]+1){
            ...
            //mostrar en mesas las disponibles
            //realizar consulta a base de datos las mesas disponibles según la fecha y hora
        }
      }        
      }
    }
